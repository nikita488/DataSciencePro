...
**Решение:** [HW4](src/HW4/HW4.ipynb)<br>
Был выбран *DCGAN*. Модифицирован под свои нужды.<br>
Тренировался на датасете *MNIST*.<br>
Лучший результат был сгенерирован на 112 эпохе.<br>